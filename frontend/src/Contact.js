...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:3500/store-user-details', { name, email, subject, message })
      ...
      <article className='Contact'>
        ...
        <article className='MyContact'>
          <ul className='ContactDetails One'>
            <li><strong>Location:</strong><br />Nairobi, Kasarani</li>
            <li><strong>Email:</strong><br />briankingara4@gmail.com</li>
            <li><strong>Call:</strong><br />0703371828</li>
          </ul>
